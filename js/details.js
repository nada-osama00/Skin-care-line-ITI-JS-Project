...
function updateStock(stockEl, stockNum) {
    ...
    var priceEl = document.getElementById('activePrice');
...
function buildInfo(prd) {
    ...
    btnCart.addEventListener('click', function () {
        ...
        var stock = activeSize ? parseInt(activeSize.dataset.stock) : currentProduct.variants[0].stock;
